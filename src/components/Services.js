    ...
    <div id="services-section">
      <AnimateStyled name="fadeIn" iterationCount="1" duration="1s">
        <div>
          ...
          <p>I am willing to work with people to meet their needs and around any budget &#8212; <span class="bold">big or small projects.</span></p>
        </div>
        <br/>
        <div className="flex">
          <div className="column-one">
            <div class="bold underline">Web Development</div>
            <ul>
          ...
          <div className="column-two">
            <div class="bold underline">Database Administration</div>
            <ul>
          ...
          <div className="column-three">
            <div class="bold underline">Cloud / Hosting</div>
            <ul>
              <li>Cloud Setup</li>
              <li>Hosting Setup</li>
